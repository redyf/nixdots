 ...
 */
// static char font[] = "Liga SFMono Nerd Font:pixelsize=14";
static char font[] = "Liga SFMono Nerd Font:pixelsize=14:antialias=true:autohint=false:hintstyle=hintfull:hinting=true";
...
/* default TERM value */
// Use "st" to emulate xterm colors I've got set up...  may be missing something here.
...
static MouseKey mkeys[] = {
    ...
    { Button4,              ShiftMask,      kscrollup,      {.i =  10} },
    { Button5,              ShiftMask,      kscrolldown,    {.i =  10} },
};
